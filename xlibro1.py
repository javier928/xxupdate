###################################################################
#
# Programa xlibro1.py desarrollado en Python 3 en Windows 10
#
# El script visualiza el primer registro de la tabla page1, page2 o page9 y
#
...
#
# La base de datos se llama test11words.db. Puede descargar el archivo .db visitando:
#
...
## el user puede elegir entre test11words.db    
cls()
superprint("0"," Welcome to SQL database editor lite")
print(" ")
zx= input(" Which database do you want to work with? <Enter 0 to exit, enter 1 for test11words.db> ")

conn= sqlite3.connect("test11words.db")
print(" ")
print(" SQLite database <test11words.db> successfully opened. ")

## preguntamos que TABLE (page of the book) queremos VER
print(" ")
